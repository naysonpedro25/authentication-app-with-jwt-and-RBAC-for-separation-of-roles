...
// src/use-cases/get-user-profile.test.ts
...
describe("Get User Profile use case", () => {
  ...
  test3("should be able get profile user", () => __async(void 0, null, function* () {
    ...
    globalExpect(user.name).toEqual(globalExpect.any(String));
  }));
  test3("should not be able get profile user with wrong id", () => __async(void 0, null, function* () {
    const userCreated = yield inMemoryRepository.create({
      name: "test-name",
      email: "email-test",
      password_hash: yield (0, import_bcryptjs.hash)("123456", 6)
