...
var DeleteUserUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      const deletedUser = yield this.userRepository.delete(userId);
      if (!deletedUser) {
        throw new ResourceNotFoundError();
      }
      return {
...
// src/use-cases/delete-user.test.ts
...
describe("Register use case", () => {
  ...
  test3("should be able varify a user", () => __async(void 0, null, function* () {
    ...
    globalExpect(inMemoryRepository.data).toEqual([]);
    globalExpect(user).include(inMemoryRepository.data);
  }));
});
