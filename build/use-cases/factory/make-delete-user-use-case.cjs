...
// src/use-cases/factory/make-delete-user-use-case.ts
var make_delete_user_use_case_exports = {};
__export(make_delete_user_use_case_exports, {
  makeDeleteUserUseCase: () => makeDeleteUserUseCase
});
module.exports = __toCommonJS(make_delete_user_use_case_exports);
