...
// src/use-cases/authenticate.test.ts
...
describe("Register use case", () => {
  ...
  test3("should be able authenticate a user", () => __async(void 0, null, function* () {
    const userCreated = yield inMemoryRepository.create({
      name: "test-name",
      email: "email-test",
      password_hash: yield (0, import_bcryptjs2.hash)("123456", 6),
    ...
    globalExpect(user.id).toEqual(userCreated.id);
  }));
  test3("should not be able authenticate with invalid email ", () => __async(void 0, null, function* () {
  ...
  test3("should not be able authenticate with invalid password", () => __async(void 0, null, function* () {
    yield inMemoryRepository.create({
      name: "test-name",
      email: "email-test",
      password_hash: "123456",
  ...
  test3("should not be able authenticate user not validated ", () => __async(void 0, null, function* () {
    yield inMemoryRepository.create({
      name: "test-name",
      email: "email-test",
      password_hash: "123456",
