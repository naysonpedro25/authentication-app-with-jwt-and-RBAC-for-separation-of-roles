...
describe("Register use case", () => {
  ...
  test3("should be able regiser a user", () => __async(void 0, null, function* () {
  ...
  test3("should be password hashed in the register", () => __async(void 0, null, function* () {
    const { user } = yield sut.execute({
      name: "name-test",
      email: "email-test",
      password: "123456"
    });
    const comparedPasswords = yield (0, import_bcryptjs2.compare)("123456", user.password_hash);
    globalExpect(comparedPasswords).toEqual(true);
  }));
  test3("should not be able register with same email", () => __async(void 0, null, function* () {
    yield sut.execute({
      name: "name-test",
      email: "email-test",
      password: "123456"
